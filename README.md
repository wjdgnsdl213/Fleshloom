...
현재 타이틀부터 9분 사냥, Warden, 엔딩·결과·재시작까지 전체 게임 흐름과 P7-2 비주얼 개선이 구현되어 있습니다. 한국어 선택 설명, 3,200×1,800 스크롤 맵, 단계 포획, 거리 기반 보행, 반복 가능한 생체 테더, 프로덕션 HUD·오디오가 한 빌드에 통합되어 있습니다. 다음 작업은 P7-3 대표 화면 정합이며, 실제 Chrome·Edge·모바일 전체 플레이 검수도 남아 있습니다.
